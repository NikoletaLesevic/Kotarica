          ...
          child: Container(
            ...
            child: Container(
              ...
              child: Row(
                ...
                ElevatedButton(
                      child:  Text(this.ocenjeno ? 'Ocenjeno' : 'Ocenite proizvod'),                                            
                      onPressed:  () {        
                  ...
                  ElevatedButton(child: Text( this.komentarisano ? 'Ostavljen komentar'  : 'Ostavite komentar', style: TextStyle(fontSize: 12),),
                  style: ElevatedButton.styleFrom(
                        primary: Colors.orange[200]),
                        onPressed: () async {
