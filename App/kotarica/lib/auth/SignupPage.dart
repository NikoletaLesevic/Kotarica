  ...
  Widget responsive_signup(UserModel listModel, BuildContext context,
    ...
    return Form(
        ...
        child: new SingleChildScrollView(
          ...
          _buildUsername(),
          //Text(
          //    "Korisničko ime mora sadržati 7-20 karaktera, koji mogu biti slova i cifre."),
          SizedBox(
            height: 30,
          ),
          Text(
          ...
          _buildPassword(),
          //Text(
          //    "Lozinka mora sadržati 7-20 karaktera, koji mogu biti slova i cifre."),
          SizedBox(
            height: 30,
          ),
          Text(
                      ...
                      Alert(
                        ...
                        buttons: [
                          ...
                          DialogButton(
                           ...
                           DialogButton(child: Text('Šta je Ethereum nalog?',style: 
                                  TextStyle(color: Colors.white, fontSize: 12),), onPressed: () {
                            showDialog(
                          context: context,
                          builder: (_) => AlertDialog(
                                content: Text(
                                    'Ethereum nalog predstavlja nalog na globalnoj Ethereum mreži, koji omogućava izvršavanje transakcija.\nSvi podaci na ovoj mreži su enkriptovani i bezbedno se čuvaju, a svaka transakcija je vidljiva svim korisnicima.\nUkoliko nemate kreiran nalog, a želite da kupujete kriptovalutom, preporučujemo sajt myetherwallet.com',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                                actions: [
                                  TextButton(
                                      onPressed: () {
                                        Navigator.pop(context);
