            ...
            child: Row(
              children: <Widget>[
                ...
                ElevatedButton(
                    ...
                    onPressed: () {
                      odabrani = new odabraniFilteri(
                          //DropDownKategorije().getKategorija,
                          //DropDownGradovi().getGrad,
                          sliderCena().getOpseg,
                          porudzbinaCheckBox().getMogucnostPorudzbine,
                          //razmenaCheckBox().getMogucnostRazmene
                          );
          ...
          /*Container(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  SizedBox(
                      height: 50, child: Image.asset('images/cityIcon.png')),
                  Text(
                    '  Mesto/Grad',
                    style: TextStyle(fontSize: 20),
                  ),
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                SizedBox(
                    height: 50, child: Image.asset('images/priceIcon.png')),
                Text(
                  '  Cena',
                  style: TextStyle(fontSize: 20),
                ),
